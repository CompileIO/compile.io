...
public class JavaBuilder extends AbstractBuilder {
    ...
    public String getDockerfileData() {
        ...
        dockerfileData.append("RUN mkdir -p $HOME/" + super.getWorkingDirectory() + "/src/main/java\n");
        dockerfileData.append("RUN mkdir -p $HOME/" + super.getWorkingDirectory() + "/src/test/java\n");
        ...
        dockerfileData.append("CMD cd .. && cd src && ls\n");
